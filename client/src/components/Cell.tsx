  ...
  return (
    ...
    >
      <input
        ...
        className={cn(
          "absolute left-0 top-0 h-full w-full animate-wave cursor-pointer border border-b-0 border-r-0 border-[#BEC6D4] bg-transparent text-center text-gray-700 caret-transparent",
