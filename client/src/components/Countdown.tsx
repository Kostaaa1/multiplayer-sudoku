...
const Countdown: FC<CountdownProps> = ({ startNewGame }) => {
  ...
  return (
    <div className="flex items-center justify-center text-3xl text-white max-[340px]:text-xs">
      <p
        className={cn(
          "text-center italic max-[340px]:text-2xl",
      ...
      <button
        onClick={resetCount}
        className="ml-2 bg-red-500 px-2 min-[340px]:text-sm"
      >
        Reset
      </button>
    </div>
